...
describe("depth", () => {
  ...
  it("eml(eml(1,1), 1) = 2", () => {
    expect(
      depth(emlNode(emlNode(constNode(1), constNode(1)), constNode(1))),
    ).toBe(2);
  });
});
...
describe("nodeCount", () => {
  ...
  it("eml(eml(1,1), 1) = 2", () => {
    expect(
      nodeCount(emlNode(emlNode(constNode(1), constNode(1)), constNode(1))),
    ).toBe(2);
  });
});
...
describe("leafCount", () => {
  ...
  it("eml(eml(1,1), 1) = 3", () => {
    expect(
      leafCount(emlNode(emlNode(constNode(1), constNode(1)), constNode(1))),
    ).toBe(3);
  });
});
